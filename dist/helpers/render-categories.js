...
export const renderCategories = (categories, categoriesContainerElement, inputChangeCallback) => {
    categories.forEach((category) => {
        ...
        const categoryElement = document.createElement("li"); // stwórz element listy
        const radioInputElement = document.createElement("input"); // określ zmienną reprezentującą kategorię
